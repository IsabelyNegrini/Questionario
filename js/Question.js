class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta:- O que é, o que é. Feito pra andar, mas não anda? " );
    // question.html("Pergunta:- O que é que está no meio do começo, no começo do meio, e no final do fim? " );

    this.question.position(150, 80);
    this.option1.html("1: A bicicleta" );
    this.option1.position(150, 100);
    this.option2.html("2: O pneu" );
    this.option2.position(150, 120);
    this.option3.html("3: A rua" );
    this.option3.position(150, 140);
    this.option4.html("4: Os pés" );
    ...
    this.button.mousePressed(()=>{
       ...
       this.message.html("Se você colocou o número 3 vc está correto(A)");
